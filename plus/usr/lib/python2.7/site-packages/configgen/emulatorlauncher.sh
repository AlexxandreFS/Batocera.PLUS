...
case $SYSTEM in
    ...
    psxpsxmini) un7zip '.ccd .CCD .cue .CUE .mdf .MDF .chd .CHD .cbn .CBN .m3u .M3U .pbp .PBP .toc .TOC .iso .ISO .bin .BIN .img .IMG' ;;
