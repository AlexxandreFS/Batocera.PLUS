...
class Rpcs3Generator(Generator):
    ...
    def generate(self, system, rom, playersControllers, gameResolution):
        ...
        #if os.path.isfile('/userdata/system/configs/rpcs3/dev_flash/vsh/etc/version.txt'):
        romBasename = path.basename(rom)
        romName = rom + '/PS3_GAME/USRDIR/EBOOT.BIN'
        commandArray = [batoceraFiles.batoceraBins[system.config['emulator']], romName]
        #else:
        #romBasename = path.basename('/userdata/bios/PS3UPDAT.PUP')
        #romName = rom + '/userdata/bios/PS3UPDAT.PUP'
        #commandArray = ["rpcs3", "--installfw", system.config['emulator'], romName]
