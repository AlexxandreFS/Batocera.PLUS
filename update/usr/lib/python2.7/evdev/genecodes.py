...
headers = [
    '/build/output/host/x86_64-buildroot-linux-gnu/sysroot/usr/include/linux/input.h',
    '/build/output/host/x86_64-buildroot-linux-gnu/sysroot/usr/include/linux/input-event-codes.h',
]
