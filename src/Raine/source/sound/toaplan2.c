...
// This file is taken almost directly from mame 125, only the interface to
// the low level functions change
/****************************************************************************
...
static const UINT8 dogyuun_cmd_snd[] =
{
/* Sound Command 13 (0x0d) is a megamix of OKI sound effects */
/* Sound Command 20 (0x14) repeats the initial crash part of the sample 4 times */
/*00*/  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
/*18*/  0x0d, 0x00, 0x11, 0x02, 0x00, 0x00, 0x00, 0x00,
...
void kbash_okisnd_w(UINT32 offset, UINT8 data)
{
...
void fixeight_okisnd_w(UINT32 offset, UINT8 data)
{
//  popmessage("Writing %04x to Sound CPU",data);
...
//  popmessage("Writing %04x to Sound CPU",data);
	...
	else if ((data > 0) && (data < 71))
	{
		play_oki_sound( dogyuun_cmd_snd[data] , data);
	}
}
