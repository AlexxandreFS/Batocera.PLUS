...
#define RDMEM_ID(a) m6502_read8(a)
#define WRMEM_ID(a,d) m6502_write8(a,d)
 ...
 *  RDOP    read an opcode
 ***************************************************************/
#define RDOP() m6502_readop(PCW++); m6502_ICount -= 1
 ...
 *  RDMEM   read memory
 ***************************************************************/
#define RDMEM(addr) m6502_read8(addr); m6502_ICount -= 1

/***************************************************************
 *  WRMEM   write memory
 ***************************************************************/
#define WRMEM(addr,data) m6502_write8(addr,data); m6502_ICount -= 1
 ...
 ***************************************************************/
#define ILL 													\
	logerror("M6502 illegal opcode %04x: %02x\n",(PCW-1)&0xffff, m6502_readop((PCW-1)&0xffff))
