...
WXWIDGETS_CONF_OPTS += --with-gtk=2 --without-libtiff --disable-mediactrl

define WXWIDGETS_FIXUP_WXWIDGET_CONFIG
       ln -sf $(STAGING_DIR)/usr/lib/wx/config/*-buildroot-linux-gnu-gtk2-unicode-* $(STAGING_DIR)/usr/bin/wx-config
