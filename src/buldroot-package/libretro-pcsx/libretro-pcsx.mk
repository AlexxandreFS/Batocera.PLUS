...
LIBRETRO_PCSX_VERSION = a4e249a1373cf6269e1e4e0d60105e72210e67d3
...
define LIBRETRO_PCSX_BUILD_CMDS
	$(TARGET_CONFIGURE_OPTS) $(MAKE) CXX="$(TARGET_CXX)" CC="$(TARGET_CC)" -C $(@D) -f Makefile.libretro platform="$(LIBRETRO_PCSX_PLATFORM)" CFLAGS_GPU_NEON=-msse4 DYNAREC=1
endef
