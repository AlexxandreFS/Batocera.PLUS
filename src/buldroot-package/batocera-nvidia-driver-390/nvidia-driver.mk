################################################################################
#
# batocera-nvidia-driver-390
#
################################################################################

BATOCERA_NVIDIA_DRIVER_VERSION = 390.143
...
BATOCERA_NVIDIA_DRIVER_LIBS_MISC = \
	...
	tls/libnvidia-tls.so.$(BATOCERA_NVIDIA_DRIVER_VERSION) \
...
BATOCERA_NVIDIA_DRIVER_X_MODS = \
	...
	extensions/libglx.so.$(BATOCERA_NVIDIA_DRIVER_VERSION) \
...
define BATOCERA_NVIDIA_DRIVER_INSTALL_TARGET_CMDS
	...
	#(SED) -i 's/__NV_VK_ICD__/libGLX_nvidia.so.0/' \
		$(TARGET_DIR)/usr/share/vulkan/icd.d/nvidia_icd.json
endef
