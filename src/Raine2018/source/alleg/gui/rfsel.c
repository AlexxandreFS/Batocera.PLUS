...
#include <allegro.h>
// These 2 files must be included before raine.h because of a collision !!!
...
DIALOG file_selector[] =
{
   ...
   { d_raine_window_proc,0,   0,    305,  161,  GUI_COL_TEXT_1,  GUI_BOX_COL_MIDDLE,  0,    0,       0,    0,    NULL },
   { x_ctext_proc,      152,  1,    1,    1,    GUI_COL_TEXT_1,    GUI_BOX_COL_MIDDLE,    0,    0,       0,    0,    NULL,             NULL, NULL  },
   { x_raine_button_proc,8,   128,  48,   16,   GUI_COL_TEXT_1,  GUI_BOX_COL_MIDDLE,  'O',  D_EXIT,  0,    0,    "&Okay" },
   { x_raine_button_proc,64,  128,  48,   16,   GUI_COL_TEXT_1,  GUI_BOX_COL_MIDDLE,  27,   D_EXIT,  0,    0,    "Cancel" },
   { fs_edit_proc,      8,    116,  248,  8,    GUI_COL_TEXT_1,  253,  0,    0,       79,   0,    NULL },
   { fs_flist_proc,     80,   20,   176,  92,   GUI_COL_TEXT_1,  GUI_BOX_COL_MIDDLE,  0,    D_EXIT,  0,    0,    fs_flist_getter },
   { fs_dlist_proc,     8,    20,   64,   92,   GUI_COL_TEXT_1,  GUI_BOX_COL_MIDDLE,  0,    D_EXIT,  0,    0,    fs_dlist_getter },
...
int raine_file_select(char *message, char *path, char *ext)
{
      ...
      return raine_file_select_ex(message, path, ext, 512, 305, 161);

   #else

      return raine_file_select_ex(message, path, ext, 512, 305, 189);
