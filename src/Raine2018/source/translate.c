// We must fake winver when cross compiling if we want the
// GetUserDefaultUILanguage definition... !
...
{
    char *language;
    // This code comes from gimp, and in gimp it was taken from some python
    // code... !
    ...
    // Now raine recognizes only fr en es pt for now...
