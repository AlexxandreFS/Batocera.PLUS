...
_hq3x_32:
    ...
    mov    esi,[esi+eax+64]
    mov    eax,[ebp+x1]
    shl	    eax,1 ; the source is still 16bpp -> x2 only
    add    esi,eax
    ...
    mov	   ebx,edx
    shl    ebx,1
    add	   edx,ebx ; 3 lines / loop... !!!
    ; *3 because after scaling, *2 because of 32bpp, mul instruction being
    ; insane because it involves 3 registers at least, we'll do without
    mov	   ebx,ecx
    shl	   ebx,1
    add	   ecx,ebx
    shl	   ecx,1
