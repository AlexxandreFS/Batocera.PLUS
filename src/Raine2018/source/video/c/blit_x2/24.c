...
void raine_blit_x2_y1_24(BITMAP *src, BITMAP *dest, int s_x, int s_y, int d_x, int d_y, int w, int h)
{
	...
	for( y = 0; y < h ; y++ )
	{
		for( x = 0, new_x = 0; x < w; x++, new_x+=6 )
		{
			...
			dest->line[ y + d_y ][ new_x + d_x+3 ] = src->line[ y + s_y ][ x + s_x   ];
			dest->line[ y + d_y ][ new_x + d_x+4 ] = src->line[ y + s_y ][ x + s_x+1 ];
			dest->line[ y + d_y ][ new_x + d_x+5 ] = src->line[ y + s_y ][ x + s_x+2 ];
		}
	}
	release_bitmap(dest);
}
...
void raine_blit_x2_y2_24(BITMAP *src, BITMAP *dest, int s_x, int s_y, int d_x, int d_y, int w, int h)
{
	...
	for( y = 0, new_y = 0; y < h ; y++, new_y+=2 )
	{
		for( x = 0, new_x = 1; x < w; x++, new_x+=6 )
		{
			...
			dest->line[ new_y + d_y   ][ new_x + d_x+3 ] = src->line[ y + s_y ][ x + s_x   ];
			dest->line[ new_y + d_y   ][ new_x + d_x+4 ] = src->line[ y + s_y ][ x + s_x+1 ];
			dest->line[ new_y + d_y   ][ new_x + d_x+5 ] = src->line[ y + s_y ][ x + s_x+2 ];
			...
			dest->line[ new_y + d_y+1 ][ new_x + d_x+3 ] = src->line[ y + s_y ][ x + s_x   ];
			dest->line[ new_y + d_y+1 ][ new_x + d_x+4 ] = src->line[ y + s_y ][ x + s_x+1 ];
			dest->line[ new_y + d_y+1 ][ new_x + d_x+5 ] = src->line[ y + s_y ][ x + s_x+2 ];
		}
	}
	release_bitmap(dest);
}
