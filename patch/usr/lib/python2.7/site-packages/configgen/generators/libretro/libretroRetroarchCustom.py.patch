--- libretroRetroarchCustom.py.original
+++ libretroRetroarchCustom.py.modificado
@@ -22,13 +22,14 @@
...
+    retroarchSettings.save('content_show_history',              '"true"')
...
+    retroarchSettings.save('menu_show_load_core',               '"true"')
+    retroarchSettings.save('menu_show_load_content',            '"true"')
+    retroarchSettings.save('menu_show_online_updater',          '"true"')
+    retroarchSettings.save('menu_show_core_updater',            '"true"')
+    retroarchSettings.save('menu_pause_libretro',               '"false"')
...
+    retroarchSettings.save('libretro_info_path',            '"/usr/lib/libretro_info"')
