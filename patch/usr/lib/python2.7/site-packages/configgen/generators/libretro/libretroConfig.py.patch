##
## A configuração do driver de vídeo padrão será configurada pelo emulatorlauncher.sh
## Alguns cores só funcionam definindo o core como glcore como o Libretro Dolphin e Kronos.
## Altera o diretório temporário usado para descompactação de arquivos cache_directory.
##
--- libretroConfig.py.original
+++ libretroConfig.py.modificado
@@ -65,12 +65,12 @@
...
+    retroarchConfig['cache_directory'] = '/userdata/extractions'
